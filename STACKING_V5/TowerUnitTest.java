...
public class TowerUnitTest
{
    ...
    /**
     * Vertificar que al agregar tapa con pushLid (),debe quedar encima de su taza en el stack 
     */
    @Test
    public void shouldPlaceLidDirectlyAboveCup() {
        ...
        assertEquals("cup", items[0][0], "pos0 type");
        assertEquals("3",   items[0][1], "pos0 size");
        assertEquals("cup", items[1][0], "pos1 type");
        assertEquals("5",   items[1][1], "pos1 size");
        assertEquals("lid", items[2][0], "pos2 type");
        assertEquals("5",   items[2][1], "pos2 size");
        assertEquals("cup", items[3][0], "pos3 type");
        assertEquals("7",   items[3][1], "pos3 size");
    }
    ...
    /**
     * swapToReduce TEST
     * Verificar que la función retorne null y deje ok enfalse ya que no hay intercambios 
